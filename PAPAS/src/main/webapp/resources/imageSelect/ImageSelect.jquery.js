...
(function($) {
    ...
    // must contains {src} placeholder. There are two class names 'chose-image' or 'chose-image-small', modify in CSS
    var fn_template = '<img class="{class_name}" src="{url}" />';

    // Store the original 'chosen' method
    var fn_chosen = $.fn.chosen;

    $.fn.chosenImageSelect = function(options) {
...
//                            var img_src = $(option).attr('data-img-src');
                            var img_src = $(option).css('background-image').replace('url(','').replace(')','');;
...
//                    var img_src  = selected.attr('data-img-src');
                    var img_src = selected.css('background-image').replace('url(','').replace(')','');;
